...
<section class="cbody">
    <h2> Manage Job</h2>
    <form action="managejob.php" method="post" enctype="multipart/form-data">
    <div class="inf"><?= $_SESSION['message'] ?></div>
        <label>Select image of job done: </label><input type="file" name="image" accept="image/*"  required><br><br>
